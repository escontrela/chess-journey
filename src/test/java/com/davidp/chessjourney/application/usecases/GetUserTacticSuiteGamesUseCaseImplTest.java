...
public class GetUserTacticSuiteGamesUseCaseImplTest {
  ...
  void execute_withValidUserId_returnsTacticSuiteGames() {
    // Arrange
    long userId = 123L;
    TacticSuiteGame suite1 =
        new TacticSuiteGame(UUID.randomUUID(), "Suite 1", TacticSuiteGame.Type.RANDOM);
    TacticSuiteGame suite2 =
        new TacticSuiteGame(UUID.randomUUID(), "Suite 2", TacticSuiteGame.Type.FIXED);
  ...
  private static class MockTacticSuiteGameRepository implements TacticSuiteGameRepository {
    ...
    @Override
    public List<com.davidp.chessjourney.domain.common.Exercise> getExercisesForSuite(
        UUID tacticSuiteGameId) {
      return null;
    }
